...
\item  Una gilette de las antiguas (ideal), o un bisturí, o al menos un cuchillo
  super afilado, pero la gilette es de lejos lo mejor.
\item  Manopla para manipular las asaderas muy calientes en el horno
\item  Idealmente un bench scrapper (ver imágen), una espátula grande, o una cuchilla grande
\end{itemize}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.35\textwidth]{bench-scraper.jpg}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{cut.jpg}
\end{figure}

\section{?`Cómo ahorrar tiempo?}
Si no tenés tiempo para seguir todo el proceso, hay ciertos atajos que podés
tomar sacrificando sabor. La siguiente es una lista de partes del proceso que
son sacrificables, arrancando por las que menos afectan al sabor (que deben ser
sacrificadas antes) y siguiendo por las que tienen consecuencias más negativas.

\begin{enumerate}
  \item Un único boleo en vez de dos: perderá un poco de forma pero no es grave.
  \item No hacer autólisis: vas a tener que amasar un poco más.
  \item No hacer retardo en heladera: esperar que este bien fermentada y directo al horno.
  \item No amasar: si tenés una harina fuerte, puede alcanzar con hacer pliegues
    sin haber amasado.
\end{enumerate}
\end{document}